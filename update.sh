...
# 			fi
		...
		"Backup")
			...
			wget https://raw.githubusercontent.com/xrayoflight/xraybot/main/dbbackupwizwiz.sh | chmod +x dbbackupwizwiz.sh
			./dbbackupwizwiz.sh
		...
		"Donate")
			echo " "
			echo -e "\n\e[91mToncoin ( TON ): \e[36mUQDkTcZP9MiudSbEiO16aHWzUN5sN6OAxzh4BEOdGN7Htd1o\033[0m\n\e[91mUSDT(TRC20): \e[36mTPYCkwkRXZPcRP12ZJKWYW5u2EmZKUYQ3M\n\e[91mBitcoin: \e[36m15cQCVpsgS3H1nfnm1F63BeKa5Uzq8gFWW\033[0m\n"
