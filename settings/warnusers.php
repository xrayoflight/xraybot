            ...
            elseif($leftgb < 1) 
                $send = "гигабайт";
                            if($send != ""){  
                                ...
                                Из услуги подписки $remark осталось всего (۱ $send). Вы можете продлить свою текущую услугу или приобрести новую из раздела 'Мои покупки'.";
    ...
    if($orders->num_rows>0){
        while ($order = $orders->fetch_assoc()){
            ...
            if($send){  
        		...
        		if(!is_null($res)){
                    $msg = "💡 Уважаемый пользователь,
                    Срок действия услуги $remark истек, и она была удалена из списка заказов. Пожалуйста, приобретите новую услугу из магазина.";
